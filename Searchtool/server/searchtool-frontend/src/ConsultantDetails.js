        ...
        <div className="topbar-inner">
          ...
          {user ? (
            <>
              ...
              {canEdit && c && (
                <button className="btn btn-primary" onClick={() => setEdit((v) => !v)}>
                  {edit ? "Exit Edit" : "Edit"}
                </button>
              )}
            </>
        ...
        <>
          <div className="consultant-header card">
            <img
              ...
              src={c.img || c.media?.photo || "https://via.placeholder.com/160"}
              alt={c.name}
            />
          ...
          <div className="consultant-grid">
            ...
            <div className="details card section">
              ...
              {!edit ? (
                <>
                  ...
                  <div className="kv">
                    ...
                    <div className="badges">
                      {arr(c.tags).length
                        ? arr(c.tags).map((t) => <span className="badge" key={t}>{t}</span>)
                        : "N/A"}
                    </div>
                  </div>
                ...
                <form className="edit-form" onSubmit={onSave}>
                  ...
                  <input className="input" value={form.expertise}
                  ...
                  <input className="input" value={form.phones}
                         onChange={(e) => setForm({ ...form, phones: e.target.value })} />

                  <label>Qualifications (comma-separated)</label>
                  <input className="input" value={form.qualifications}
                  ...
                  <label>Summary</label>
                  <textarea className="input textarea" rows={4} value={form.summary}
            ...
            <AssociationsBox
              ...
              onSaved={(next) => setC(prev => ({ ...prev, associations: next }))}
            />
            ...
            <div className="exp card section">
                  ...
                  {c.experience.map((e, i) => (
                    <li key={i}>
                      ...
                      <div className="exp-sub">
                        {(e.start || e.end)
                          ? `${fmtMonth(e.start)} – ${e.end ? fmtMonth(e.end) : "Present"}`
                          : ""}
              ...
              {perms?.canEditExperience && (
                <>
                  {!showExpForm ? (
                    <button className="btn" onClick={() => setShowExpForm(true)}>
                      + Add experience
                    </button>
                  ) : (
                    <form className="exp-form" onSubmit={submitExperience}>
                      <div className="row">
                        <div className="col">
                          ...
                          <input className="input" value={expForm.role}
                                 onChange={(e) => setExpForm({ ...expForm, role: e.target.value })} required />
                        </div>
                        <div className="col">
                          <label className="lbl">Organization / Client</label>
                          <input className="input" value={expForm.org}
                      ...
                      <div className="row">
                        <div className="col">
                          ...
                          <input className="input" value={expForm.location}
                                 onChange={(e) => setExpForm({ ...expForm, location: e.target.value })} />
                        </div>
                        <div className="col">
                          <label className="lbl">Start (Month & Year)</label>
                          <input className="input" type="month" value={expForm.startMonth}
                                 onChange={(e) => setExpForm({ ...expForm, startMonth: e.target.value })} />
                        </div>
                        <div className="col">
                          <label className="lbl">End (Month & Year)</label>
                          <input className="input" type="month" value={expForm.endMonth}
            ...
            <div className="reviews card section">
              <div className="reviews-header">
                ...
                <div className="avg-text">
                  {ravg ? `${ravg.toFixed(1)} / 5 (${rcount} reviews)` : "No ratings yet"}
                </div>
              </div>
              ...
              {perms?.canAddReview ? (
                <form className="review-form" onSubmit={postReview}>
                  ...
                  <select className="select" value={revRating}
